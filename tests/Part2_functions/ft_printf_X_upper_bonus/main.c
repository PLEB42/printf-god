...
int main(int argc, char **argv)
{
	...
	if (test_num == 1)
		...
		ret = ft_printf("%.4x", 424242);
	else if (test_num == 7)
		ret = ft_printf("%15.4x", 42);
	else if (test_num == 8)
		ret = ft_printf("%15.4x", 424242);
	else if (test_num == 9)
		ret = ft_printf("%8.4x", 424242424);
	else if (test_num == 10)
		ret = ft_printf("%4.15x", 42);
	else if (test_num == 11)
		ret = ft_printf("%4.15x", 424242);
	else if (test_num == 12)
		ret = ft_printf("%4.8x", 424242424);
	else if (test_num == 13)
		...
		ret = ft_printf("%5x", 52625);
	else if (test_num == 17)
		ret = ft_printf("%2x", 94827);
	else if (test_num == 18)
		ret = ft_printf("%-7x", 33);
	else if (test_num == 19)
		ret = ft_printf("%-3x", 0);
		...
		ret = ft_printf("%-4x", 9648627);
	else if (test_num == 22)
		ret = ft_printf("%.5x", 21);
	else if (test_num == 23)
		ret = ft_printf("%.3x", 0);
	else if (test_num == 24)
		ret = ft_printf("%.4x", 5263);
	else if (test_num == 25)
		ret = ft_printf("%.3x", 938862);
	else if (test_num == 26)
		ret = ft_printf("%05x", 43);
	else if (test_num == 27)
		ret = ft_printf("%03x", 0);
	else if (test_num == 28)
		ret = ft_printf("%03x", 698334);
	else if (test_num == 29)
		ret = ft_printf("%8.5x", 34);
	else if (test_num == 30)
		ret = ft_printf("%8.5x", 0);
	else if (test_num == 31)
		ret = ft_printf("%8.3x", 8375);
	else if (test_num == 32)
		ret = ft_printf("%2.7x", 3267);
	else if (test_num == 33)
		ret = ft_printf("%3.3x", 6983);
	else if (test_num == 34)
		ret = ft_printf("%-8.5x", 34);
	else if (test_num == 35)
		ret = ft_printf("%-8.5x", 0);
		...
		ret = ft_printf("%08.5x", 34);
	else if (test_num == 40)
		ret = ft_printf("%08.5x", 0);
	else if (test_num == 41)
		ret = ft_printf("%08.3x", 8375);
	else if (test_num == 42)
		ret = ft_printf("%02.7x", 3267);
	else if (test_num == 43)
		ret = ft_printf("%03.3x", 6983);
	else if (test_num == 44)
		ret = ft_printf("%hhx", (unsigned char)45);
	else if (test_num == 45)
		ret = ft_printf("%hx", (unsigned short)385);
	else if (test_num == 46)
		ret = ft_printf("%hhx", uch_pos_1);
	else if (test_num == 47)
		ret = ft_printf("%hx", ush_pos_1);
	else if (test_num == 48)
		ret = ft_printf("%hx", (unsigned short)65535);
	else if (test_num == 49)
		ret = ft_printf("%hhx", (unsigned char)255);
	else if (test_num == 50)
		ret = ft_printf("%037lx", 22337203685477ul);
	else if (test_num == 51)
		ret = ft_printf("%37llx", 522337203685470ull);
	else if (test_num == 52)
		ret = ft_printf("this %#X number", 17);
	else if (test_num == 53)
		ret = ft_printf("this %#X number", 0);
	else if (test_num == 54)
		ret = ft_printf("%#X", 3);
	else if (test_num == 55)
		ret = ft_printf("%#X", 4294967295u);
	else if (test_num == 56)
		ret = ft_printf("%#7x", 33);
	else if (test_num == 57)
		ret = ft_printf("%#3x", 0);
	else if (test_num == 58)
		ret = ft_printf("%#7x", 52625);
	else if (test_num == 59)
		ret = ft_printf("%#2x", 94827);
	else if (test_num == 60)
		ret = ft_printf("%#-7x", 33);
		...
		ret = ft_printf("%#lx", (unsigned long)32);
	else if (test_num == 89)
		ret = ft_printf("%#llx", (long long)43);
	else if (test_num == 90)
		ret = ft_printf("%#hhx", uch_pos_1);
	else if (test_num == 91)
		ret = ft_printf("%#hx", ush_pos_1);
	else if (test_num == 92)
		ret = ft_printf("%#lx", ul_pos_1);
	else if (test_num == 93)
		ret = ft_printf("%#llx", ull_pos_1);
	else if (test_num == 94)
		ret = ft_printf("%#lx", 22337203685477ul);
	else if (test_num == 95)
		ret = ft_printf("%#llx", 522337203685470ull);
	else if (test_num == 96)
		ret = ft_printf("%#llx", ullmax);
	else if (test_num == 97)
		ret = ft_printf("%#lx", ulmax);
	else if (test_num == 98)
		ret = ft_printf("%#hx", (unsigned short)65535);
	else if (test_num == 99)
		ret = ft_printf("%#hhx", (unsigned char)255);
		...
		ret = ft_printf("{%500X}", 0xdead);
	else if (test_num == 189)
		ret = ft_printf("{%-500X}", 0xbeef);
	else if (test_num == 190)
		ret = ft_printf("%.500X", 0xabcd);
	else if (test_num == 191)
		ret = ft_printf("%#500X", 0x1234);
	else if (test_num == 192)
		ret = ft_printf("%#0500X", 0x1234);
	else if (test_num == 193)
		ret = ft_printf("%#-500X", 0x1234);
	else if (test_num == 194)
		ret = ft_printf("%#.500X", 0x1234);
	else if (test_num == 195)
		ret = ft_printf("%#500.250X", 0x1234);
	else if (test_num == 196)
		ret = ft_printf("%#250.500X", 0x1234);
	else if (test_num == 197)
		ret = ft_printf("%.X", 0x0);
	else if (test_num == 198)
		ret = ft_printf("%.0X", 0x0);
	else if (test_num == 199)
		ret = ft_printf("%5.0X", 0x0);
	else if (test_num == 200)
		ret = ft_printf("%#5.0X", 0x0);
	else if (test_num == 201)
		ret = ft_printf("%500X", 0x123);
	else if (test_num == 202)
		ret = ft_printf("%-500X", 0x123);
	else if (test_num == 203)
		ret = ft_printf("%0500X", 0x123);
	else if (test_num == 204)
		ret = ft_printf("%#500X", 0x123);
	else if (test_num == 205)
		ret = ft_printf("%1000X", 0x123);
	else if (test_num == 206)
		ret = ft_printf("%-1000X", 0x123);
	else if (test_num == 207)
		ret = ft_printf("%01000X", 0x123);
	else if (test_num == 208)
		ret = ft_printf("%#1000X", 0x123);
	else if (test_num == 209)
		ret = ft_printf("%300.150X", 0x99999);
	else if (test_num == 210)
		ret = ft_printf("%#300.150X", 0x99999);
	else if (test_num == 211)
		ret = ft_printf("%300.450X", 0x99999);
	else if (test_num == 212)
		ret = ft_printf("%#300.450X", 0x99999);
	else if (test_num == 213)
		ret = ft_printf("%600.150X", 0x99999);
	else if (test_num == 214)
		ret = ft_printf("%#600.150X", 0x99999);
	else if (test_num == 215)
		ret = ft_printf("%600.450X", 0x99999);
	else if (test_num == 216)
		ret = ft_printf("%#600.450X", 0x99999);
	else if (test_num == 217)
		ret = ft_printf("%#400.200X", 0xabcde);
	else if (test_num == 218)
		ret = ft_printf("%#401.201X", 0xabcdf);
	else if (test_num == 219)
		ret = ft_printf("%#402.202X", 0xabce0);
	else if (test_num == 220)
		ret = ft_printf("%#403.203X", 0xabce1);
	else if (test_num == 221)
		ret = ft_printf("%#404.204X", 0xabce2);
	else if (test_num == 222)
		ret = ft_printf("%#405.205X", 0xabce3);
	else if (test_num == 223)
		ret = ft_printf("%#406.206X", 0xabce4);
	else if (test_num == 224)
		ret = ft_printf("%#407.207X", 0xabce5);
	else if (test_num == 225)
		ret = ft_printf("%#408.208X", 0xabce6);
	else if (test_num == 226)
		ret = ft_printf("%#409.209X", 0xabce7);
	else if (test_num == 227)
		ret = ft_printf("%#410.210X", 0xabce8);
	else if (test_num == 228)
		ret = ft_printf("%#411.211X", 0xabce9);
	else if (test_num == 229)
		ret = ft_printf("%#412.212X", 0xabcea);
	else if (test_num == 230)
		ret = ft_printf("%#413.213X", 0xabceb);
	else if (test_num == 231)
		ret = ft_printf("%#414.214X", 0xabcec);
	else if (test_num == 232)
		ret = ft_printf("%#415.215X", 0xabced);
	else if (test_num == 233)
		ret = ft_printf("%#416.216X", 0xabcee);
	else if (test_num == 234)
		ret = ft_printf("%#417.217X", 0xabcef);
	else if (test_num == 235)
		ret = ft_printf("%#418.218X", 0xabcf0);
	else if (test_num == 236)
		ret = ft_printf("%#419.219X", 0xabcf1);
		...
		ret = ft_printf("%#408.208X", 0xabce6);
	else if (test_num == 275)
		ret = ft_printf("%#409.209X", 0xabce7);
	else if (test_num == 276)
		ret = ft_printf("%#410.210X", 0xabce8);
	else if (test_num == 277)
		ret = ft_printf("%#411.211X", 0xabce9);
	else if (test_num == 278)
		ret = ft_printf("%#412.212X", 0xabcea);
	else if (test_num == 279)
		ret = ft_printf("%#413.213X", 0xabceb);
	else if (test_num == 280)
		ret = ft_printf("%#414.214X", 0xabcec);
	else if (test_num == 281)
		ret = ft_printf("%#415.215X", 0xabced);
	else if (test_num == 282)
		ret = ft_printf("%#416.216X", 0xabcee);
	else if (test_num == 283)
		ret = ft_printf("%#417.217X", 0xabcef);
	else if (test_num == 284)
		ret = ft_printf("%#418.218X", 0xabcf0);
	else if (test_num == 285)
		ret = ft_printf("%#419.219X", 0xabcf1);
	else if (test_num == 286)
		ret = ft_printf("%#420.220X", 0xabcf2);
	else if (test_num == 287)
		ret = ft_printf("%#421.221X", 0xabcf3);
	else if (test_num == 288)
		ret = ft_printf("%#422.222X", 0xabcf4);
	else if (test_num == 289)
		ret = ft_printf("%#423.223X", 0xabcf5);
	else if (test_num == 290)
		ret = ft_printf("%#424.224X", 0xabcf6);
printf("\n[RET: %d]", ret);
	return 0;
}
