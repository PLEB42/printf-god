...
int main(int argc, char **argv)
{
	...
	if (test_num == 1)
		...
		ret = ft_printf("before %u after", 42);
	else if (test_num == 3)
		ret = ft_printf("%u%u%u%u%u", 1, 100, 999, 42, 999988888);
	else if (test_num == 4)
		ret = ft_printf("a%ub%uc%ud", 0, 55555, 100000);
	else if (test_num == 5)
		...
		ret = ft_printf("%u", UINT_MAX + 1);
	else if (test_num == 17)
		ret = ft_printf("%-u", 42);
	else if (test_num == 18)
		ret = ft_printf("this %u number", 17);
	else if (test_num == 19)
		ret = ft_printf("this %u number", 0);
	else if (test_num == 20)
		ret = ft_printf("%u", 3);
	else if (test_num == 21)
