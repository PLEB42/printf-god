...
int main(int argc, char **argv) {
	...
	else if (test_num == 2) ret = ft_printf(" %p ", 15);
	else if (test_num == 3) ret = ft_printf(" %p ", 16);
	else if (test_num == 4) ret = ft_printf(" %p ", 17);
	else if (test_num == 5) ret = ft_printf(" %p %p ", LONG_MIN, LONG_MAX);
	else if (test_num == 6) ret = ft_printf(" %p %p ", INT_MIN, INT_MAX);
	else if (test_num == 7) ret = ft_printf(" %p ", -1);
